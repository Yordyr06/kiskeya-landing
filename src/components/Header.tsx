export const Header = (): JSX.Element => {
  return (
    <header className="relative flex  w-full min-w-80 justify-between p-4">
      <section className="relative flex min-w-64 content-center">
        <span className="my-auto font-extrabold text-transparent text-4xl bg-clip-text bg-gradient-to-r from-pink-300 to-orange-700">
          <h1>
            Kiskeya Landing
          </h1>
        </span>
